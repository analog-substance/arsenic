...
git clone https://github.com/analog-substance/hugo && \
...
RUN go get github.com/analog-substance/fast-resolv
RUN cp /root/go/src/github.com/analog-substance/fast-resolv/fast-resolv.conf /root/go/bin/
